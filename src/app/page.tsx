...
export default function Home() {
  ...
  const currentClasses = styles[currentStyle] || styles[0]; // Fallback to first style if current is undefined
  ...
  return (
    <AnimatePresence>
      <motion.main
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className={`${currentClasses.main} transition-all duration-500 ease-in-out ${isDarkMode ? 'dark-mode' : ''}`}
      >
